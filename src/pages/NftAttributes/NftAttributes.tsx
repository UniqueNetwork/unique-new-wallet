...
const NftAttributes = () => {
  return (
    <>
      ...
      <Text>
        This functionality allows you to customize the token. You can define
        your NFT traits in the fields below. For example, name, accessory,
        gender, background, face, body, tier etc.
      </Text>
      <Table
        columns={[
          {
